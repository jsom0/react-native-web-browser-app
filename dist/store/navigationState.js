...
const navigationSlice = createSlice({
    ...
    // updateUrlBarText(
    //   state,
    //   action: PayloadAction<{text: string; fromNavigationEvent: boolean}>,
    // ) {
    ...
    //     state.tabs[state.activeTab].isSecure = text.startsWith('https://')
    //       ? true
    ...
    //   state,
    //   action: PayloadAction<{progress: number; tab?: string}>,
    // ) {
...
export function submitUrlBarTextToWebView(text, tab) {
    return function (dispatch, getState) {
        ...
        return dispatch(navigationSlice.actions.setUrlOnWebView({
            url,
