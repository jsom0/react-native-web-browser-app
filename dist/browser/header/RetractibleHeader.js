...
export class RetractibleHeader extends React.Component {
    ...
    constructor(props) {
        ...
        this.animatedNavBarTranslateYPortrait = Animated.interpolate(this.props.scrollY, input, outputTranslateYPortrait, Animated.Extrapolate.CLAMP);
        this.animatedNavBarTranslateYLandscape = Animated.interpolate(this.props.scrollY, input, outputTranslateYLandscape, Animated.Extrapolate.CLAMP);
